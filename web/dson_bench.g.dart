...
part of serialise.dson_bench;

// **************************************************************************
// Generator: InitMirrorsGenerator
// Target: library serialise.dson_bench
// **************************************************************************
...
abstract class _$SimpleSerializable extends SerializableMap {
  ...
  get keys => SimpleClassMirror.fields.keys;
}

_Simple__Constructor(params) =>
    new Simple(id: params['id'], value: params['value'], flag: params['flag']);
...
const SimpleClassMirror =
  ...
  '': const FunctionMirror(parameters: const {
    'id': const DeclarationMirror(type: String, isOptional: true),
    'value': const DeclarationMirror(type: double, isOptional: true),
    'flag': const DeclarationMirror(type: bool, isOptional: true)
  }, call: _Simple__Constructor)
}, fields: const {
  'id': $$Simple_fields_id,
...
abstract class _$ComplexSerializable extends SerializableMap {
  ...
  get keys => ComplexClassMirror.fields.keys;
}

_Complex__Constructor(params) =>
    new Complex(simple: params['simple'], list: params['list']);
...
const ComplexClassMirror =
  ...
  '': const FunctionMirror(parameters: const {
    'simple': const DeclarationMirror(type: Simple, isOptional: true),
    'list':
        const DeclarationMirror(type: const [List, Simple], isOptional: true)
  }, call: _Complex__Constructor)
}, fields: const {
